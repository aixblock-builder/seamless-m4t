...
if __name__ == "__main__":
    ...
    def download_file():
        ...
        if not filename:
            import shutil
            directory_to_zip = "/app/models/vocoder_v2"
            zip_file_path = "/app/models.zip"

            # Kiểm tra nếu file zip đã tồn tại thì xóa
            if os.path.exists(zip_file_path):
                os.remove(zip_file_path)

            # Nén thư mục
            shutil.make_archive(base_name="/app/models", format='zip', root_dir=directory_to_zip)
